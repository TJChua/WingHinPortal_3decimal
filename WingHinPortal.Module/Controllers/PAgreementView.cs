...
namespace WingHinPortal.Module.Controllers
{
    ...
    public partial class PAgreementView : ObjectViewController<ListView, PurchaseBlanketAgreementDetails>
    {
        public PAgreementView()
        {
            InitializeComponent();
        ...
        {
            if (e.CreatedObject is PurchaseBlanketAgreementDetails && View.IsRoot == false)
            {
                PurchaseBlanketAgreementDetails currentObject = (PurchaseBlanketAgreementDetails)e.CreatedObject;
                ...
                if (lv.CollectionSource is PropertyCollectionSource)
                {
                    ...
                    {
                        if (collectionSource.MasterObjectType == typeof(PurchaseBlanketAgreement))
                        {
                            PurchaseBlanketAgreement masterobject = (PurchaseBlanketAgreement)collectionSource.MasterObject;
