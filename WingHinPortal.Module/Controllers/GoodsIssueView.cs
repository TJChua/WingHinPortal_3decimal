...
namespace WingHinPortal.Module.Controllers
{
    ...
    public partial class GoodsIssueView : ObjectViewController<ListView, GoodsIssueDetails>
    {
        ...
        {
            if (e.CreatedObject is GoodsIssueDetails && View.IsRoot == false)
            {
                GoodsIssueDetails currentObject = (GoodsIssueDetails)e.CreatedObject;
                ...
                if (lv.CollectionSource is PropertyCollectionSource)
                {
                    ...
                    {
                        if (collectionSource.MasterObjectType == typeof(GoodsIssue))
                        {
                            GoodsIssue masterobject = (GoodsIssue)collectionSource.MasterObject;
