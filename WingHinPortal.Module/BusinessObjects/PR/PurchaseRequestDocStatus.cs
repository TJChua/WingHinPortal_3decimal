...
namespace WingHinPortal.Module.BusinessObjects.PR
{
    ...
    [Appearance("PRTrxDocStatuses4", AppearanceItemType = "Action", TargetItems = "Delete", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("PRTrxDocStatuses5", AppearanceItemType = "Action", TargetItems = "Unlink", Context = "Any", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [DefaultProperty("StatusInfo")]
    [XafDisplayName("Document Status Log")]
    public class PurchaseRequestDocStatus : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        private PurchaseRequest _PurchaseRequests;
        ...
        public PurchaseRequest PurchaseOrder
        {
