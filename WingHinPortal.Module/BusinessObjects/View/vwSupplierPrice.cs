...
namespace WingHinPortal.Module.BusinessObjects.View
{
    ...
    public class vwSupplierPrice : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public vwSupplierPrice(Session session)
            : base(session)
        {
        }
        ...
        [Index(8), VisibleInLookupListView(true), VisibleInListView(true), VisibleInDetailView(true)]
