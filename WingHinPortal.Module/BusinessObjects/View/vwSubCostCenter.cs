...
namespace WingHinPortal.Module.BusinessObjects.View
{
    ...
    public class vwSubCostCenter : XPLiteObject
    { 
        public vwSubCostCenter(Session session)
            : base(session)
        {
        }
        ...
        [Appearance("PrcCode", Enabled = false)]
        public string PrcCode { get; set; }

        [VisibleInLookupListView(true), VisibleInListView(true), VisibleInDetailView(true)]
        [Appearance("PrcName", Enabled = false)]
