...
namespace WingHinPortal.Module.BusinessObjects.Setup
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        // Start ver 1.0.2
        private bool _Dimension1;
        [XafDisplayName("Dimension 1")]
        [Index(8)]
        public bool Dimension1
        {
            get { return _Dimension1; }
            set
            {
                SetPropertyValue("Dimension1", ref _Dimension1, value);
            }
        }

        private bool _Dimension2;
        [XafDisplayName("Dimension 2")]
        [Index(10)]
        public bool Dimension2
        {
            get { return _Dimension2; }
            set
            {
                SetPropertyValue("Dimension2", ref _Dimension2, value);
            }
        }
        // End ver 1.0.2
